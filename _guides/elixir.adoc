...
The `=` operator isn’t an assignment. `=` operator is actually a match operator.
...
When matching maps though, you can match on one or more keys in the map, which gives you the syntax:
