...
Essentially Bundler is a smart way to puts all the gems need by your project "on the load path". It bypass the default rubygems and it's usefull because guarantee that you use the exact gems version listed in you Gemfile.lock.
...
## GUIDE: Basic Versioning Rules for Apps
